...
- Are expensive tests marked `@pytest.mark.slow` and/or `@pytest.mark.integration` per `pytest.ini`, and documented against **T0–T3** (`.claude/commands/test-tiers.md`)?
