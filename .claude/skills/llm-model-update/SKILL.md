...
Rule courte (invariants) : [`.claude/rules/llm.md`](../../rules/llm.md)  
...
- [ ] 8. llm.md + OPENAI_API_GPT5.md alignés si comportement change
```
...
| `.claude/rules/llm.md` | faits courants (pas toute la procédure) |
