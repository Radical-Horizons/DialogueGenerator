...
Rule versioning : [`.claude/rules/app_versioning.md`](../../rules/app_versioning.md) · Rule déploiement : [`.claude/rules/deployment.md`](../../rules/deployment.md)
...
Obligatoire avant push/deploy sur `main` — [`.claude/rules/ci_before_push.md`](../../rules/ci_before_push.md) :
...
Variantes : `deploy:skip-build`, `deploy:skip-restart` — voir `deployment.md`.
