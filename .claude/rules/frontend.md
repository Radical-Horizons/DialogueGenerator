...
- **Déterminisme**: Ne pas s'appuyer sur le backend ou l'IA pour des comportements déterministes. Ex. : si l'utilisateur a sélectionné un choix (ex. "Choix #3") et demande à l'IA de générer un nœud, la liaison parent→nouveau nœud via ce choix doit être faite côté front (état connu : `target_choice_index`), pas déléguée à une "suggestion" API. 
