...
def get_benchmark_criteria_store(request: Request):
    ...
    Returns:
        Instance de BenchmarkCriteriaStore depuis le ServiceContainer.
    """
    return get_service_container(request).get_benchmark_criteria_store()


def get_benchmark_judge_pass_service(request: Request):
    """Retourne la passe de jugement du benchmark.

    Args:
        request: Requête HTTP courante.

    Returns:
        Instance de BenchmarkJudgePassService depuis le ServiceContainer.
    """
    return get_service_container(request).get_benchmark_judge_pass_service()


def get_benchmark_pairwise_pass_service(request: Request):
    """Retourne la passe de comparaison par paires du benchmark.

    Args:
        request: Requête HTTP courante.

    Returns:
        Instance de BenchmarkPairwisePassService depuis le ServiceContainer.
    """
    return get_service_container(request).get_benchmark_pairwise_pass_service()


def get_benchmark_report_service(request: Request):
    """Retourne le service d'aperçu et de rapport du benchmark.

    Args:
        request: Requête HTTP courante.

    Returns:
        Instance de BenchmarkReportService depuis le ServiceContainer.
    """
    return get_service_container(request).get_benchmark_report_service()
